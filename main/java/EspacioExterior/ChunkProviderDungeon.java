...
public class ChunkProviderDungeon extends ChunkProviderGenerate
{
	private final Random rand;

	private final World worldObj;

	public ChunkProviderDungeon(World par1World, long par2, boolean par4)
	{
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		if (k == 0 && l == 0)
		{
			this.worldObj.setBlock(k, 64, l, CreacionDeBloques.blockMaderaRefinada, 0, 3);
