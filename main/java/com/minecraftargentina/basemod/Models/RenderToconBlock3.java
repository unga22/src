...
//Renderizado 3D importando ".obj" from Blender. 
	...
	public class RenderToconBlock3 extends TileEntitySpecialRenderer{
	    ...
	    public RenderToconBlock3(){
	    	
	    	//Resource by Name
	    	ArbolPlataform = new ResourceLocation(BaseMod.modid + ":" + "textures/model/TreeTrunk2.obj");
		...
		public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
			...
			renderModelAt((TileEntityArbolTocon3)tileentity, x, y, z, f);
