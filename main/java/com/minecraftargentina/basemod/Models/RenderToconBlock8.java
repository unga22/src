...
//Renderizado 3D importando ".obj" from Blender. 
	...
	public class RenderToconBlock8 extends TileEntitySpecialRenderer{
	    ...
	    public RenderToconBlock8(){
	    	
	    	//Resource by Name
	    	ArbolPlataform = new ResourceLocation(BaseMod.modid + ":" + "textures/model/TreeTrunk3-90.obj");
		...
		public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
			...
			renderModelAt((TileEntityArbolTocon8)tileentity, x, y, z, f);
