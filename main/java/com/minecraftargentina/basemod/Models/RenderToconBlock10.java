...
//Renderizado 3D importando ".obj" from Blender. 
	...
	public class RenderToconBlock10 extends TileEntitySpecialRenderer{
	    ...
	    public RenderToconBlock10(){
	    	
	    	//Resource by Name
	    	ArbolPlataform = new ResourceLocation(BaseMod.modid + ":" + "textures/model/TreeHOJAS-903.obj");
		...
		public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
			...
			renderModelAt((TileEntityArbolTocon10)tileentity, x, y, z, f);
