package com.minecraftargentina.basemod.Maquinas.AlabasterOven;
...
public class AlabasterOven extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(BaseMod.modid + ":" + "AlabasterOvenSide");
		this.iconFront = iconRegister.registerIcon(BaseMod.modid + ":" + (this.isActive ? "AlabasterOvenFrontOn" : "AlabasterOvenFrontOff"));
		this.iconTop = iconRegister.registerIcon(BaseMod.modid + ":" + "AlabasterOvenTop");
	}
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(CreacionDeMaquinas.blockAlabasterOvenIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, BaseMod.instance, CreacionDeMaquinas.guiIDAlabasterOven, world, x, y, z);
		}
		return true;
	}
	...
	public static void updateAlabasterOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, CreacionDeMaquinas.blockAlabasterOvenActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, CreacionDeMaquinas.blockAlabasterOvenIdle);
		}
