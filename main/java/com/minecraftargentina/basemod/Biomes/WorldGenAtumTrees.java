...
public class WorldGenAtumTrees extends WorldGenerator
{
    ...
    void genTreeLayer(int par1, int par2, int par3, float par4, byte par5, BlockLeaves leaves)
    {
        ...
        for (aint1[par5] = aint[par5]; j1 <= i1; ++j1)
        {
            ...
            while (k1 <= i1)
            {
                ...
                else
                {
                    ...
                    {
                   if(leaves != Blocks.leaves)
                    		this.setBlockAndMetadata(this.worldObj, aint1[0], aint1[1], aint1[2], leaves, 0);
                        ++k1;
                    }
                }
            }
     ...
     */
    void placeBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, BlockLeaves par3)
    {
    ...
    void generateTrunk()
    {
        ...
        this.placeBlockLine(aint, aint1, (BlockLeaves) Blocks.planks);
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] aint = new int[] {this.basePos[0], this.basePos[1], this.basePos[2]}; i < j; ++i)
        {
            ...
            {
                this.placeBlockLine(aint, aint2, (BlockLeaves) Blocks.planks);
            }
        }
    }
    ...
    //    Block soil = Block.blocksList[i];
        boolean isValidSoil = i == Blocks.sand;
        if (!isValidSoil)
        {
            return false;
        }
