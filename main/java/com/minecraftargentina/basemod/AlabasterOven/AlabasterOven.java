package com.minecraftargentina.basemod.AlabasterOven;
...
public class AlabasterOven extends BlockContainer {
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(BaseMod.blockAlabasterOvenIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, BaseMod.instance, BaseMod.guiIDAlabasterOven, world, x, y, z);
		}
		return true;
	}
	...
	public static void updateAlabasterOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, BaseMod.blockAlabasterOvenActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, BaseMod.blockAlabasterOvenIdle);
		}
