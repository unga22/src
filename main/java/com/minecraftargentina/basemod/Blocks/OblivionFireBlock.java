...
public class OblivionFireBlock extends BlockFire
{
private boolean chanceToEncourageFire;
private boolean abilityToCatchFire;
@SideOnly(Side.CLIENT)
private Icon[] iconArray;
public OblivionFireBlock(Material cactus)
{
super();
...
{
this.abilityToCatchFire = true;
this.chanceToEncourageFire = true;
setBurnRate(Blocks.planks, 5, 20);
setBurnRate(Blocks.wooden_slab, 5, 20);
setBurnRate(Blocks.wooden_pressure_plate, 5, 20);
setBurnRate(Blocks.fence, 5, 20);
setBurnRate(Blocks.acacia_stairs, 5, 20);
setBurnRate(Blocks.spruce_stairs, 5, 20);
setBurnRate(Blocks.birch_stairs, 5, 20);
setBurnRate(Blocks.jungle_stairs, 5, 20);
...
setBurnRate(Blocks.wool, 30, 60);
setBurnRate(Blocks.vine, 15, 100);
}
private void setBurnRate(Block block, int par2, int par3)
{
...
{
Block base = Block.blockRegistry[par1World.getBlockMetadata(par2, par3 - 1, par4)];
