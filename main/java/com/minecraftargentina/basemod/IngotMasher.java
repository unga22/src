...
public class IngotMasher extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
    	if (!world.isRemote) {    		
    		...
    		FMLNetworkHandler.openGui(player, BaseMod.instance, BaseMod.guiIDIngotMasher, world, x, y, z);    		
	...
	public static void updateBlockState(boolean isMashing, World world, int xCoord, int yCoord, int zCoord) {
		...
		if (isMashing) {
			world.setBlock(xCoord, yCoord, zCoord, BaseMod.blockIngotMasherActive);
		}else{
			world.setBlock(xCoord, yCoord, zCoord, BaseMod.blockIngotMasherIdle);
