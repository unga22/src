...
if (i1 >= 0 && i1 < 256)
{
k1 = par1World.getBlockMetadata(l1, i1 -1, j1);
/** Custom grass block **/
Block block = CreacionDeBloques.blockMaderaRefinada;
...
// Custom grass block
&& k1 != CreacionDeBloques.blockMaderaRefinada = 1111;
...
/** Custom grass block **/
Block soil = CreacionDeBloques.blockMaderaRefinada;

/** Custom Sapling block **/
boolean isSoil = (soil != null && soil.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (IPlantable)CreacionDeBloques.blockSapling));
...
{
/** Custom leaf block **/
//this.setBlockAndMetadata(par1World, j2, j1, l2, CreacionDeBloques.blockLeaf, this.metaLeaves);
}
}
}
}
...
//this.setBlockAndMetadata(par1World, par3 + Direction.offsetX[Direction.rotateOpposite[k1]], par4 + l - 5 + j1, par5 + Direction.offsetZ[Direction.rotateOpposite[k1]], Blocks.cocoa, i2 << 2 | k1);
}
}
}
}
