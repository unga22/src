...
//Renderizado 3D importando ".obj" from Blender. 
	...
	public class RenderToconBlock7 extends TileEntitySpecialRenderer{
	    ...
	    public RenderToconBlock7(){
	    	
	    	//Resource by Name
	    	ArbolPlataform = new ResourceLocation(BaseMod.modid + ":" + "textures/model/TreeTrunk2-90.obj");
		...
		public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
			...
			renderModelAt((TileEntityArbolTocon7)tileentity, x, y, z, f);
