...
//Renderizado 3D importando ".obj" from Blender. 
	...
	public class RenderToconBlock4 extends TileEntitySpecialRenderer{
	    ...
	    public RenderToconBlock4(){
	    	
	    	//Resource by Name
	    	ArbolPlataform = new ResourceLocation(BaseMod.modid + ":" + "textures/model/TreeTrunk3.obj");
		...
		public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
			...
			renderModelAt((TileEntityArbolTocon4)tileentity, x, y, z, f);
